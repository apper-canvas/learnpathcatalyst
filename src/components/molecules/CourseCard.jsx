...
const CourseCard = ({ course, progressPercentage, isEnrolled, onEnroll, index }) => {
    return (
        <motion.div
                    ...
                    {!isEnrolled && onEnroll && (
                        <div className="mt-4">
                            <button
                                ...
                                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-4 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                            >
                                Enroll For Free
                            </button>
                        </div>
